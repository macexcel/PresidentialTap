...
public class Duterte extends AppCompatActivity {

    private int seconds = 0; // <<<<
    private boolean wasRunning = false;
    private boolean isRunning = false;
    private boolean counterrunner = false;
    private int tapduterte; // <<<<<<
    static int limitcounter = 86400; //1 day waiting <<<<<
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duterte);
    ...
    public void onClickStart(View view) {
        ...
        String taps = String.format("%d", tapduterte);
    ...
    protected void onPause() {
        ...
        pref.edit().putInt("tapduterte", tapduterte).apply();
        ...
        try {
            ...
            new Shared().UpdateTaps(mTable, "duterte", tapduterte);

            // display message toaster.
            Toast.makeText(this, "Duterte's taps count has been updated!", Toast.LENGTH_SHORT).show();
        }
    ...
    protected void onResume() {
        ...
        tapduterte = 0; //pref.getInt("tapduterte", 0);
        seconds = pref.getInt("seconds", 0);
        timelimit = pref.getInt("timelimit", 3600);
        limitcounter = pref.getInt("limitcounter", 86400);

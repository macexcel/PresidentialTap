...
public class Roxas extends AppCompatActivity {
    private int seconds = 0;
    private boolean wasRunning = false;
    private boolean isRunning = false;
    private boolean counterrunner = false;
    private int taproxas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roxas);
    ...
    public void onClickStart(View view) {
        ...
        String taps = String.format("%d", taproxas);
    ...
    protected void onPause() {
        ...
        // save the preferences for Roxas.
        pref.edit().putInt("taproxas", taproxas).apply();
        ...
        try {
            ...
            new Shared().UpdateTaps(mTable, "roxas", taproxas);

            Toast.makeText(this, "Roxas' taps count has been updated!", Toast.LENGTH_SHORT).show();
        }
    ...
    protected void onResume() {
        ...
        taproxas = 0; //pref.getInt("taproxas", 0);
        seconds = pref.getInt("seconds", 0);
        timelimit = pref.getInt("timelimit", 3600);
        limitcounter = pref.getInt("limitcounter", 86400);

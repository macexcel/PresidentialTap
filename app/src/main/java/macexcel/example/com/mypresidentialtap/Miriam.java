...
public class Miriam extends AppCompatActivity {
    private int seconds = 0;
    private boolean wasRunning = false;
    private boolean isRunning = false;
    private boolean counterrunner = false;
    private int tapmiriam;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_miriam);
    ...
    public void onClickStart(View view) {
        ...
        String taps = String.format("%d", tapmiriam);
    ...
    protected void onPause() {
        ...
        // save the preferences for Miriam.
        pref.edit().putInt("tapmiriam", tapmiriam).apply();
        ...
        try {
            ...
            new Shared().UpdateTaps(mTable, "miriam", tapmiriam);

            Toast.makeText(this, "Miriam's taps count has been updated!", Toast.LENGTH_SHORT).show();
        }
    ...
    protected void onResume() {
        ...
        tapmiriam = 0; //pref.getInt("tapmiriam", 0);
        seconds = pref.getInt("seconds", 0);
        timelimit = pref.getInt("timelimit", 3600);
        limitcounter = pref.getInt("limitcounter", 86400);
